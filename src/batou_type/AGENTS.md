...
- `setup.py` — Project setup: copies stub packages and writes checker config to pyproject.toml. Stdlib + structlog + tomli-w.
...
- `setup.py` → no imports from any batou_type module (stdlib + structlog + tomli-w)
