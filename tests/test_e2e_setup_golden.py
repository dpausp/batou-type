...
class TestGoldenFiles:
    """Character-exact comparison of setup output against golden files."""

    def test_fresh_project_all_checkers(self, fresh_project: Path) -> None:
        ...
        assert actual == golden, (
            ...
            f"Use: diff tests/golden/setup/fresh_all_checkers.toml <(cat {fresh_project}/pyproject.toml | sed 's/{fresh_project.name}/TEST_PROJECT_NAME/')"
        )

    def test_existing_project_all_checkers(self, existing_project: Path) -> None:
    ...
    def test_fresh_project_ty_only(self, fresh_project: Path) -> None:
    ...
    def test_idempotent_matches_golden(self, fresh_project: Path) -> None:
