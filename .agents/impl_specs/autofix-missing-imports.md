...
implementation_plan:
  ...
  description: "Add autofix capabilities to batou-type: two libcst-based fixers (add-missing-import, self-deref), four CLI flags (--fix, --diff, --fix-only, --virtual), run_fix pipeline, three-tier tests"
  git_rev: 8c597bf
  created_at: "2026-04-29T17:30:00Z"
  target_tests:
    - file: tests/impl_spec/test_autofix_missing_imports.py
      tests:
        - TestFixerModule::test_module_importable
        - TestFixerModule::test_fixer_dataclass_exists
        - TestFixerModule::test_fixer_has_slug_field
        - TestFixerModule::test_fixer_has_diagnostic_codes_field
        - TestFixerModule::test_fixer_has_apply_field
        - TestFixerModule::test_add_missing_import_fixer_registered
        - TestFixerModule::test_self_deref_fixer_registered
        - TestFixerModule::test_diagnostic_codes_is_frozenset
        - TestFixerModule::test_apply_callable
        - TestFixerModule::test_apply_returns_none_when_no_change
        - TestFixerModule::test_apply_returns_str_on_change
        - TestAddMissingImportFixer::test_inserts_from_import
        - TestAddMissingImportFixer::test_merges_into_existing_import
        - TestAddMissingImportFixer::test_inserts_after_existing_imports
        - TestSelfDerefFixer::test_walrus_wrap_when_self_deref_referenced
        - TestSelfDerefFixer::test_replaces_self_dot_underscore_with_underscore
        - TestSelfDerefFixer::test_no_transform_when_self_deref_not_referenced
        - TestSelfDerefFixer::test_chained_access_transformed
        - TestCLIFlags::test_fix_flag_exists
        - TestCLIFlags::test_diff_flag_exists
        - TestCLIFlags::test_fix_only_flag_exists
        - TestCLIFlags::test_virtual_flag_exists
        - TestFlagImplications::test_diff_implies_fix_only
        - TestFlagImplications::test_fix_only_implies_fix
        - TestFlagImplications::test_diff_implies_both
        - TestRunFixFunction::test_run_fix_importable
        - TestRunFixFunction::test_run_fix_accepts_expected_params
        - TestFixerArchitecture::test_fixer_may_import_output
        - TestFixerArchitecture::test_fixer_no_cli_import
        - TestFixerArchitecture::test_fixer_no_plugin_import
        - TestFixerArchitecture::test_fixer_no_core_direct
        - TestFixerArchitecture::test_fixer_no_typer
        - TestFixerArchitecture::test_fixer_no_rich
        - TestFixerArchitecture::test_fixer_no_pytest
        - TestFixerArchitecture::test_fixer_no_structlog
        - TestFixerArchitecture::test_fixer_no_stogger
        - TestFixerArchitecture::test_cli_may_import_fixer
        - TestLibcstDependency::test_libcst_importable
        - TestLibcstDependency::test_libcst_in_pyproject_dependencies
```
